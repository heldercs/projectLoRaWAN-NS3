 ...
 * =====================================================================================
 *
 *       Filename:  mtc-network-sim.cc
 *
 *    Description:  This code simulates a complex scenario for machine type communication
 *    with multiple gateways and end devices (regular and alarm). The metric of interest 
 *    for this code is the throughput, loss packet, and delay of the network.
 *
 *        Version:  1.0
 *        Created:  24/11/2018 10:16:41
 *       Revision:  none
 *       Compiler:  gcc
 *
