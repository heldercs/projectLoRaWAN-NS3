...
# Plot the data
plot filename1 using 1:2 w lp lw 2 t '1 GW free space', filename2 using 1:2 w lp lw 2 t '7 GW free space', filename3 using 1:2 w lp lw 2 t '1 GW shadowning', filename4 using 1:2 w lp lw 2 t '7 GW shadowning' 
